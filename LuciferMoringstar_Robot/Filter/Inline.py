...
def get_reply_markup(query):
    buttons = [[
        InlineKeyboardButton('Support', url='t.me/requestprime'),
        InlineKeyboardButton('More Botz', url='t.me/moviezzprime')
        ],[
        InlineKeyboardButton('Updates, url=f'https://t.me/moviezzprime')
        ],[
